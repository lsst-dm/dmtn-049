...
\item {\bf Phase 3:} Facilitate community participation in a "Photo-$z$ Validation Cooperative" that will analyze photo-$z$ estimates based on commissioning data, which will inform DM's selection of community-vetted photo-$z$ estimator(s) for DR1.
\end{itemize}
}
