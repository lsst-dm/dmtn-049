...
The selection criteria will include technical considerations imposed by the DM System. 
...
From these letters, DM will generate a shortlist of community-vetted photo-$z$ options that meet both the community's scientific needs for DR {\tt Object} photo-$z$ and the technical directives of the DM System.
...
As part of DM's process to select, implement, and validate one or more estimator(s) from this shortlist, DM will facilitate community participation in a "Photo-$z$ Validation Cooperative" based on commissioning data (\S~\ref{sec:pzcoop}). 
