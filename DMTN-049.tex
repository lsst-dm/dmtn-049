...
\item {\bf Phase 3:} Facilitate community participation in a "photo-$z$ validation cooperative" based on commissioning data that informs DM's selection of the community-vetted photo-$z$ estimator(s) to be used for DR1.
\end{itemize}
}
...
\subsection{Phase 3: Photo-$z$ Validation Cooperative}\label{ssec:time_pzcoop}

{\bf During commissioning:} facilitate community participation in a "Photo-$z$ Validation Cooperative" for the shortlisted estimators based on commissioning data.
...
Towards this end the DM team plans to facilitate a "photo-$z$ validation cooperative" based on LSST commissioning data.
...
{\bf It is anticipated that this process will start with open communication about what the science community needs, in terms of commissioning data and access to tools and computational resources, to fully participate in the photo-$z$ cooperative.}
