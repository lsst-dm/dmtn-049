...
\item {\bf Phase 3:} Facilitate community participation in a "Photo-$z$ Validation Cooperative" that will analyze photo-$z$ estimates based on commissioning data, which will inform DM's selection of the community-vetted photo-$z$ estimator(s) to be used for DR1.
\end{itemize}
}
