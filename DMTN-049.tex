...
The relevant requirement is DMS-REQ-0046 (see \citeds{LSE-61}), ``The DMS shall compute a photometric redshift for all detected Objects". From the Jira conversation on this issue we've managed to cobble together some potential internal uses for a Level 2 photo-$z$:
