...
% % % % % % % % % % % % % %
%\subsubsection{Photo-$z$ as an In-Kind Contribution}\label{ssec:dmingest_inkind}
%
...
% The following is a proposal for the minimum attributes of the {\tt Object} catalog photo-$z$, based on the use-cases in \S~\ref{sec:use}.
