...
\textbf{The primary milestone in this roadmap is DM's call for "Letters of Recommendation" from the science community regarding photo-$z$ estimators (\S~\ref{sec:lor}; preliminary deadline 2021-09-30).}
...
\addtohist{5}{2021-01-1}{Updates to Section 3:Technical Considerations }{Jim Bosch, Leanne Guy}
}
...
{\bf 2021-02-01:} Write a summary of this proposed timeline, post it to the community forum \url{Community.lsst.org}, and advertise it broadly.
...
All software and auxiliary data resulting from the any training procedure should be made available to the Data Management team together with the estim
