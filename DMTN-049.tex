...
The commissioning surveys and their schedule remain subject to change; the examples below will be updated in the future as the situation clarifies.
Data Preview 1 (DP1) and Data Preview 2 (DP2)will be based on data taken during Rubin Observatory commissioning.

{\bf Data Preview 1 (DP1):} The first phase of commissioning comprises 3 months of technical integration and test with the Rubin Observatory Commissioning Camera (ComCam) and might include, e.g., tests of the scheduler; tests of image quality, depth, astrometry, and photometry; 
% descoped in LCR-2045
% and a 20-year depth test to stack images over a range of conditions 
% Very out of date - 2018. Remove until Chuck updates
% \citedsp{LSE-79}.
...
{\bf Data Preview 2 (DP2):} The second phase of commissioning with the LSST Camera (LSSTCam) \textemdash \,the science instrument for Rubin Observatory,  might include, e.g., wide area surveys to the full 10-year depth in addition to a 20-year depth stack and tests of image quality, as in DP1 
\citedsp{LSE-79}.
