...
{\bf LSST Photo-$z$ Virtual Forums} are proposed as a means of facilitating community-project interaction and soliciting input.
...
The virtual forums would {\it not} be the only way to contribute -- community input will also be ingested to this document from, e.g., written postings on Community.lsst.org.
...
{\bf Nov, Dec 2020:} Hold two LSST Photo-$z$ Virtual Forums that focus on gathering project and community input on the proposed roadmap and its timeline. \\
...
{\bf Nov 2021 -- Apr 2022:} Hold four LSST Photo-$z$ Virtual Forums that focus on allowing the project and the community discuss the various features, merits, or drawbacks photo-$z$ estimators. \\
