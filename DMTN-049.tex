...
\setDocAbstract{
This is a \textit{\textbf{living document}} to guide the processes of: (1) defining the science-driven requisite attributes and performance of the {\tt Object} catalog photo-$z$; (2) evaluating and selecting one or more photo-$z$ estimators; and (3) implementing, validating, documenting, and serving the {\tt Object} catalog photo-$z$.
This document will evolve over time to incorporate input about this process and the photo-$z$ data products from the science community (including the Science Collaborations), the Rubin Observatory Data Management and Operations teams, and potential in-kind contributors.
