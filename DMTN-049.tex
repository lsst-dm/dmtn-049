...
This stages of this roadmap were developed with the in-kind contributions in mind, to create a timeline and communication methods that will assist with the inclusion and integration of the in-kind program contributions related to photo-$z$.
...
However, this IPC group is not entirely a separate process to this roadmap.
...
As this is a living document, this section can be updated as the role of the in-kind contributors clarifies after the review process concludes.
