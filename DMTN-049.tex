...
This stages of this roadmap were developed with the in-kind contributions in mind, to create a timeline and communication methods that will assist with the development and integration of the in-kind program contributions related to photo-$z$.
...
For in-kind programs making photo-$z$ related contributions to the project, a Photo-$z$ In-Kind Program Coordination group exists help the in-kind teams navigate the proposal process and to facilitate communications about the contributions between the teams and their recipients, the Rubin Observatory and/or the Science Collaborations.
See this post in the Community Forum for more information: \url{https://community.lsst.org/t/about-the-photo-z-in-kind-coordination-group}.
This Photo-$z$ In-Kind Program Coordination group is not separate from this roadmap, nor from the US and Chilean science community that will also contribute to the LSST photo-$z$.
The primary home for all of this group's related discussions is the "Science - Photometric Redshifts" category of the Community Forum, the same space being used as the central discussion forum for this roadmap and all aspects of the LSST photo-$z$.

Over time, the in-kind programs will transition from the proposal stage to creating and delivering their contributions, and the LSST Photo-$z$ Virtual Forums and Letters of Recommendation phases will inspire communication and collaboration about photo-$z$ within the Rubin community.
The long-term design for this roadmap is for all of these efforts to have merged by the time we begin the Photo-$z$ Validation Cooperative during commissioning.
...
For example, in-kind teams proposing to contribute photo-$z$ related directable effort or software packages to Rubin Observatory might be helping DM to evaluate the "Letters of Recommendation", or to set up infrastructure to run the "Photo-z Validation Cooperative".
...
Throughout 2021, participation in the "LSST Photo-z Virtual Forums" from all groups related to photo-$z$ will help to clarify the various activities.
As this is a living document, this section can be updated as the role of the in-kind contributors clarifies and evolves after the review process concludes.
